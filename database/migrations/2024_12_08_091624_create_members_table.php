...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('members', function (Blueprint $table) {
            ...
            $table->text('affiliated_committee')->nullable()->comment('소속 위원회명');
            $table->string('reelection_status', 50)->nullable()->comment('재선 구분명');
            $table->string('term_number', 255)->nullable()->comment('당선 대수');
            $table->string('gender', 10)->nullable()->comment('성별');
            $table->string('phone_number', 255)->nullable()->comment('전화번호');
